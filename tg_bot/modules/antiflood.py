...
from telegram import Message, Chat, Bot, Update, User

from tg_bot import WHITELIST_USERS, SARDEGNA_USERS, dispatcher
...
from telegram.ext import CallbackQueryHandler, CommandHandler, Filters, MessageHandler, run_async
...
def check_flood(bot: Bot, update: Update) -> str:
    ...
    if (is_user_admin(chat, user.id) or user.id in SARDEGNA_USERS or user.id in WHITELIST_USERS):
